...

{
...

    {
        ...
        if ((array_key_exists('provincials', $lst) && $lst['provincials'] != null) && (array_key_exists('district', $lst) && $lst['district'] != null) && (array_key_exists('lowest-price', $lst) && $lst['lowest-price'] != null)) {
            ...
            $result = $result->where('news_province', 'like', '%'.$lst['provincials'].'%')->where('news_district', 'like', '%'.$lst['district'].'%')->orderBy('news_price_from')->limit($limit)->offset($offset)->get();
        ...
        // District, province, highest-price
            ...
            $result = $result->where('news_province', 'like', '%'.$lst['provincials'].'%')->where('news_district', 'like', '%'.$lst['district'].'%')->orderBy('news_price_from', 'desc')->limit($limit)->offset($offset)->get();
        ...
        // District, highest-price
            ...
            $result = $result->where('news_district', 'like', '%'.$lst['district'].'%')->orderBy('news_price_from', 'desc')->limit($limit)->offset($offset)->get();
        ...
        // District, lowest-price
            ...
            $result = $result->where('news_district', 'like', '%'.$lst['district'].'%')->orderBy('news_price_from')->limit($limit)->offset($offset)->get();
        ...
        // Province, highest-price
            ...
            $result = $result->where('news_province', 'like', '%'.$lst['provincials'].'%')->orderBy('news_price_from', 'desc')->limit($limit)->offset($offset)->get();
        ...
        // Province, lowest-price
            ...
            $result = $result->where('news_province', 'like', '%'.$lst['provincials'].'%')->orderBy('news_price_from')->limit($limit)->offset($offset)->get();
        ...
        // Else 
            ...
            if (array_key_exists('lowest-price', $lst) && $lst['lowest-price'] != null) {
                ...
                $result = $result->orderBy('news_price_from')->limit($limit)->offset($offset)->get();

            }

            if (array_key_exists('highest-price', $lst) && $lst['highest-price'] != null) {

                $result = $result->orderBy('news_price_from', 'desc')->limit($limit)->offset($offset)->get();
